...
// @access  Private
const getUserProfile = asyncHandler(async (req: BaseRequest, res: express.Response) => {
...
// @access  Private
const updateUserProfile = asyncHandler(async (req: BaseRequest, res: express.Response) => {
  const user = await User.findById(req.user._id)
...
const getUsers = asyncHandler(async (req: express.Request, res: express.Response) => {
