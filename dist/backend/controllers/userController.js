...
// @access  Private
const getUserProfile = asyncHandler((req, res) => __awaiter(void 0, void 0, void 0, function* () {
...
const updateUserProfile = asyncHandler((req, res) => __awaiter(void 0, void 0, void 0, function* () {
    ...
    if (user) {
        ...
        res.json({
            ...
            token: (0, generateToken_js_1.default)(updatedUser._id),
        });
    }
    else {
        res.status(404);
...
// @access  Private/Admin
const getUserById = asyncHandler((req, res) => __awaiter(void 0, void 0, void 0, function* () {
