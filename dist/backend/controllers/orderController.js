...
// @access  Private
const addOrderItems = asyncHandler((req, res) => __awaiter(void 0, void 0, void 0, function* () {
...
// @access  Private
const getOrderById = asyncHandler((req, res) => __awaiter(void 0, void 0, void 0, function* () {
...
// @access  Private
const updateOrderToPaid = asyncHandler((req, res) => __awaiter(void 0, void 0, void 0, function* () {
...
const updateOrderToDelivered = asyncHandler((req, res) => __awaiter(void 0, void 0, void 0, function* () {
    const order = yield orderModel_1.default.findById(req.params.id);
    if (order) {
...
// @access  Private
const getMyOrders = asyncHandler((req, res) => __awaiter(void 0, void 0, void 0, function* () {
